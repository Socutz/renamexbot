...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://github.com/Socutz/renamexbot.git")
        ]
...
async def about(bot, msg):
    me=await bot.get_me()
    Master=f"<a href=https://t.me/hdmoviessec>movie</a> & <a href=https://t.me/hdmoviessec>movie</a>"  
    Source="<a href=https://github.com/socutz/Simple-Rename-Bot>Click Here</a>"
